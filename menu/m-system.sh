...
CEKEXPIRED () {
    ...
    Exp1=$(curl -sS https://raw.githubusercontent.com/aaiki9/autosc/main/permission/ip | grep $MYIP | awk '{print $3}')
    if [[ $today < $Exp1 ]]; then
...
0) clear ; menu ; exit ;;
x) exit ;;
*) echo -e "" ; echo "Masukkan Angka Yang Benar" ; sleep 1 ; m-system ;;
esac
